  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-12 col-lg-6">
        ...
        <div class="mb-4"><b>ENAE.pe</b> es la plataforma digital especializada en clases y banco de preguntas para el ENAE.
        </div>
        <ul class="fa-ul mb-4">
          <li class="mt-1"><span class="fa-li"><i aria-hidden="true"
                class="fal fa-check-circle opacity-3"></i></span>Clases con especialistas para el ENAE</li>
          <li class="mt-1"><span class="fa-li"><i aria-hidden="true"
                class="fal fa-check-circle opacity-3"></i></span>Practica con exámenes ilimitados</li>
          <li class="mt-1"><span class="fa-li"><i aria-hidden="true"
                class="fal fa-check-circle opacity-3"></i></span>Con más de 1200 preguntas para el ENAE y el Residentado de Enfermería</li>
          <li class="mt-1"><span class="fa-li"><i aria-hidden="true"
      ...
      <div class="col-5 m-auto col-md-4 col-lg-3 m-lg-0">
        <img class="img-fluid" src="{{ asset('/img/welcome/enae/hero-phone.png') }}"
          alt="Vista de respuesta de un examen en ENAE.pe" style="transform: rotate(5deg);">
      </div>
    </div>
  </div>
</section>
