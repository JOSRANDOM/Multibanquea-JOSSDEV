  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-12 col-lg-6">
        ...
        <div class="mb-4"><b>ENAO.pe</b> es la plataforma digital especializada en el repaso de preguntas para el ENAO y el Residentado de Odontología.
        </div>
        <ul class="fa-ul mb-4">
          ...
          <li class="mt-1"><span class="fa-li"><i aria-hidden="true"
                class="fal fa-check-circle opacity-3"></i></span>Con más de 1500 preguntas para el ENAO y el Residentado de Odontología</li>
          <li class="mt-1"><span class="fa-li"><i aria-hidden="true"
      ...
      <div class="col-5 m-auto col-md-4 col-lg-3 m-lg-0">
        <img class="img-fluid" src="{{ asset('/img/welcome/enao/hero-phone.png') }}"
          alt="Vista de respuesta de un examen en ENAO.pe" style="transform: rotate(5deg);">
      </div>
    </div>
  </div>
</section>
