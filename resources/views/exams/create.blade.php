        ...
        <div class="card-body py-lg-5">
            <div class="row">
                <div class="col-12 col-md-6 d-flex gap-3 align-items-md-center">
                    ...
                    <div>
                        <h3>{{ env('SIMULACRUM_CREATE_TITLE','Examenes de curso') }}</h3>
                        <p class="mb-lg-0 text-secondary">{{ env('SIMULACRUM_CREATE_DESCRIPTION','listado de examenes programados') }}</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 d-flex align-items-center justify-content-end">
        ...
        <div class="card-body py-lg-5">
            <div class="row">
                <div class="col-12 col-md-6 d-flex gap-3 align-items-md-center">
                    ...
                    <div>
                        <h3>{{ env('EXTRAORDINARY_CREATE_TITLE','Examenes de curso') }}</h3>
                        <p class="mb-lg-0 text-secondary">{{ env('EXTRAORDINARY_CREATE_DESCRIPTION','listado de examenes programados') }}</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 d-flex align-items-center justify-content-end">
                    <a href="{{ route('exams.create.extraordinary') }}" class="btn btn-primary stretched-link">
                        Seleccionar</a>
                </div>
            </div>
        </div>
