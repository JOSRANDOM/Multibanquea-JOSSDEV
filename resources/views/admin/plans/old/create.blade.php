...
@section('content')
<x-title label="{{ __('plans.new') }}" previous-url="{{ route('admin.plans.index') }}" />
      ...
      <div class="card mb-4">
        <div class="card-body">
          <form method="POST" action="{{ route('admin.plans.store') }}">
            ...
            <div><button type="button" data-toggle="modal" data-target="#modal-plan-create" class="btn btn-primary">{{ __('plans.create') }}</button></div>
