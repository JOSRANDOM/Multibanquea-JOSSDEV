  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-12 col-lg-6">
        ...
        <div class="mb-4">Simulacros ilimitados y más de 6000 preguntas en la plataforma más moderna del Perú.</div>
      ...
      <div class="col-5 m-auto col-md-4 col-lg-3 m-lg-0">
        <img class="img-fluid" src="{{ asset('/img/welcome/enam/hero-phone.png') }}" alt="Vista de respuesta de un examen en ENAM.pe" style="transform: rotate(5deg);">
      </div>
    </div>
  </div>
</section>
