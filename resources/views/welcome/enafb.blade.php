  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-12 col-lg-6">
        ...
        <h1 class="mb-4">Banquea sin límites para el Examen Nacional de Farmacia y Bioquímica</h1>
      ...
      <div class="col-5 m-auto col-md-4 col-lg-3 m-lg-0">
        <img class="img-fluid" src="{{ asset('/img/welcome/enafb/hero-phone.png') }}" alt="Vista de respuesta de un examen en ENAFB.pe" style="transform: rotate(5deg);">
      </div>
    </div>
  </div>
</section>
